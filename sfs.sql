...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2026 at 05:24 PM
...
(4, 5, 8, 'Rejected', '// Send as JSON since document uploads are disabled// Send as JSON since document uploads are disabled// Send as JSON since document uploads are disabled// Send as JSON since document uploads are disabled', NULL, NULL, NULL, '2026-04-23 12:42:58', '2026-04-23 12:43:18');
...
(19, 5, 1, '2026-04-25 09:36:23'),
(20, 5, 2, '2026-04-25 12:36:50');
...
(2, 5, 'status', 'Application Status Update', 'Your application for Spongebob Scholarships was not selected at this time. Please check other opportunities.', 8, 4, 1, '2026-04-23 12:43:18', '2026-04-25 09:36:35'),
(3, 5, 'status', 'Application Approved!', 'Congratulations! Your application for Google Excellence Scholarship has been approved. You will be contacted with further instructions.', 2, NULL, 0, '2026-04-25 12:39:16', '2026-04-25 12:39:16'),
(4, 1, 'status', 'Application Approved!', 'Congratulations! Your application for DOST Science & Technology Scholarship has been approved. You will be contacted with further instructions.', 1, NULL, 0, '2026-04-25 12:45:17', '2026-04-25 12:45:17'),
(5, 1, 'status', 'Application Status Update', 'Your application for Google Excellence Scholarship was not selected at this time. Please check other opportunities.', 2, NULL, 0, '2026-04-25 12:46:29', '2026-04-25 12:46:29');
...
(7, 'JUAN scholarship', 'Juan', 'Merit', 'juan provides scholarships', '[\"Full tuition coverage\"]', '₱2,500', 1, 3.00, '2026-04-17', 'University Portal', 'https://forms.google.com/juanaward', 'juan@scholarship.com', '{\"gwa\":\"3.0\",\"courses\":\"BSCS, BSHM, BSES\",\"yearLevel\":[\"1st Year\"]}', '[\"Submit application form\",\"Submit proof of enrollment\"]', '2026-04-22 10:38:14', '2026-04-25 13:18:11'),
...
(2, 5, 'TOVOLRON', 'Male', '123, Pineapple Street, BIkini Bottom', 'Earth State University', 'BSCS', '4th Year', 3.00, 'High Income', '09123456789', '2026-04-05 15:19:52', '2026-04-25 13:19:03', '/uploads/profile-1775404125872-525757832.jpg', 100),
