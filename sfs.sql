...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 13, 2026 at 01:09 PM
...
(3, 'Academic Merit Award', 'State University Foundation', 'Merit', 'Merit-based scholarship for high-achieving students across all disciplines.', '[\"Tuition reduction of $3,000 per semester\", \"Priority course registration\", \"Access to honors lounge\"]', '$3,000/semester', 100, 3.80, '2026-03-31', 'University Portal', 'https://forms.google.com/merit-award', 'foundation@stateuniversity.edu', '{\"gpa\": 3.8, \"courses\": [\"All Programs\"], \"yearLevel\": [\"2nd Year\", \"3rd Year\", \"4th Year\"]}', '[\"Submit application through university portal\", \"No additional documents required (automatic review based on grades)\"]', '2026-04-11 10:09:39', '2026-04-11 10:09:39'),
...
(1, 4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-05 15:19:52', '2026-04-05 15:19:52', NULL, 20),
(2, 5, 'TOVOLRON', 'Male', '123, Pineapple Street, BIkini Bottom', 'Earth State University', 'BS BIAS', '4th Year', 2.50, 'Middle Income', '09123456789', '2026-04-05 15:19:52', '2026-04-06 10:45:15', '/uploads/profile-1775404125872-525757832.jpg', 100),
(3, 6, 'HI', 'Male', '123, Pineapple Street, BIkini Bottom', '', '', '', 0.00, 'Middle Income', '09123456789', '2026-04-06 10:52:53', '2026-04-06 10:53:36', NULL, 40),
(4, 7, 'VJ ABJELINA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 11:06:06', '2026-04-10 11:06:06', NULL, 20),
(5, 8, '12 34', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-04-10 13:08:42', '2026-04-10 13:08:42', NULL, 20);
...
INSERT INTO `user` (`id`, `Name`, `Email`, `Password`, `RegistrationDate`) VALUES
(4, 'John Doe', 'john.doe@gmail.com', '$2a$10$pRer9P5dPBK1cQSwPpSbDees0Wguh0O3gUU5ur2Ig77x0CjT51Js2', '2026-03-31 03:19:46'),
(5, 'TOVOLRON', 'tovolron@gmail.com', '$2a$10$m1PgKcoQZORBOr4ylcrZO.TXClI9PekUipRYz42eAe6JccbUZUk0m', '2026-04-03 19:32:06'),
(6, 'HI', 'hi@gmail.com', '$2a$10$GuZBn/8oqJvZz7wB5l3BqOC/lmkPm8TATxRi8s7DqEE/4Glyey602', '2026-04-06 18:52:53'),
(7, 'VJ ABJELINA', 'vj.abjelina@bisu.edu.ph', '$2a$10$q3Jm.mbBZjbmapTwHqsQceJDQgLZzV16CDXhA/5OpsaxEAQRIu1QG', '2026-04-10 19:06:06'),
(8, '12 34', 'abjelinav1@gmail.com', '$2a$10$oxQnvZLz8QMtgKpfrtMaQ.TnliV/PW7ZbuTlKiZzcgWzJ1M26.H2i', '2026-04-10 21:08:42');
...
ALTER TABLE `favorites`
  ...
  ADD UNIQUE KEY `StudentID` (`StudentID`,`ScholarshipID`),
...
--
ALTER TABLE `favorites`
  ADD CONSTRAINT `favorites_ibfk_1` FOREIGN KEY (`StudentID`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `favorites_ibfk_2` FOREIGN KEY (`ScholarshipID`) REFERENCES `scholarship` (`ScholarshipID`);
