...
export const scholarshipMapper = {
  ...
  getGpaRequirement: (scholarship: any) => scholarship.gpaRequirement || scholarship.GPARequirement || 0,
  ...
  getScholarshipData: (scholarship: any) => ({
    ...
    gpaRequirement: scholarship.gpaRequirement || scholarship.GPARequirement || 0,
