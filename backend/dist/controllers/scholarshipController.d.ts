...
export declare function createScholarship(req: Request, res: Response): Promise<void>;
export declare function updateScholarship(req: Request, res: Response): Promise<void>;
