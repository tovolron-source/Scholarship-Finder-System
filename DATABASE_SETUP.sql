-- Scholarship Finder System - SQL Database Setup
-- Run this SQL code in your MySQL client to set up the complete database schema
-- Date: April 21, 2026
...
-- 1. User Table - Stores all user accounts (students and admins)
...
-- 2. Student Profile Table - Stores detailed student information
...
-- 3. Scholarship Table - Stores all available scholarships
...
-- 4. Favorite Table - Stores student's favorite scholarships
...
-- 5. Application Table - Stores all student scholarship applications
...
-- Add role column to user table (for existing databases without the role column)
...
-- INSERT INTO user (Name, FullName, Email, Password, role) 
-- VALUES ('Admin', 'Administrator', 'admin@scholarship.com', '$2a$10$...', 'admin');

-- Insert a test student user (password: student123)
-- INSERT INTO user (Name, FullName, Email, Password, role) 
-- VALUES ('John', 'John Doe', 'john@example.com', '$2a$10$...', 'student');

-- Insert a test scholarship
-- INSERT INTO scholarship (ScholarshipName, Provider, Type, Description, Amount, GWARequirement, Deadline)
-- VALUES ('Merit Scholarship 2024', 'University', 'Merit', 'For outstanding students', '₱50,000', 1.5, '2024-06-30');

-- Verify the tables were created
SHOW TABLES;
SHOW COLUMNS FROM user;
SHOW COLUMNS FROM student_profile;
SHOW COLUMNS FROM scholarship;
SHOW COLUMNS FROM favorite;
